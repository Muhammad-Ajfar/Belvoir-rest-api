...
namespace Belvoir.DAL.Repositories.Admin
{
    public interface IOrderRepository
    {
        ...
        public Task<IEnumerable<AdminTailorOrderGet>> AdminGetTailorOrder(Guid? userId, string? status);
        public Task<IEnumerable<AdminRentalOrderGet>> AdminGetRentalOrder(Guid? userId, string? status);
    ...
    public class OrderRepository: IOrderRepository
    {
        ...
        public async Task<IEnumerable<AdminTailorOrderGet>> AdminGetTailorOrder(Guid? userId, string? status)
        {
        ...
        public async Task<IEnumerable<AdminRentalOrderGet>> AdminGetRentalOrder(Guid? userId, string? status)
        {
